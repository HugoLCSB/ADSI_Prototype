jQuery("#simulation")
  .on("click", ".s-c11a5deb-45c6-4e0d-b18e-9d58a71b7399 .click", function(event, data) {
  ...
  .on("pageload", ".s-c11a5deb-45c6-4e0d-b18e-9d58a71b7399 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
